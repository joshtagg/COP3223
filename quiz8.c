//Fill in the following program so that the user can choose a function,
//input parameters, and receive the correct calculation
...
//Pre-condition: base is a real number, exp >= 0
//Post-condition: Returns base raised to the exp power
int exp(int base, int exponent) {
    int i, result = 1;
